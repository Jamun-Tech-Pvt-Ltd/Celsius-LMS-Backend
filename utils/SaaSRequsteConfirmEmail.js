                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img alt="Company Logo"
                                                                        src="https://jmkcrsmn.s3.us-east-2.amazonaws.com/images/logo.png"
                                                                        style="display: block; height: auto; border: 0; width: 91px; max-width: 100%;"
                                                                        title="Company Logo" width="91" /></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img
                                                                        ...
                                                                        src="https://jmkcrsmn.s3.us-east-2.amazonaws.com/images/round_corner_top.png"
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="text-align:center;width:100%;">
                                                                <h1
                                                                    ...
                                                                    <strong>Welcome to Jaamun<br /> #1 e-Learning
                                                                        Platform </strong>
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            request for our SaaS service has been
                                                                            successfully verified. You can now access
                                                                            the features and resources of our platform.
                                                                            If you have any questions or need further
                                                                            assistance, feel free to reach out to our
                                                                            support team at info@jaamun.com.
                                                                            Thank you for choosing Jaamun. We look
                                                                            forward to supporting your needs.
                                                                        </p>

                                                                        <ul>
                                                                            <li><strong>Your Admin Url:</strong>
                                                                                ${c_username}.admin.jaamun.com</li>
                                                                            <li><strong>Admin user id:</strong>
                                                                                ${c_email}</li>
                                                                            <li><strong>Admin Password:</strong>
                                                                                ${c_password}</li>
                                                                            <li><strong>Student Pannel Url:</strong>
                                                                                ${c_username}.student.jaamun.com</li>
                                                                            <li><strong>Trainer Pannel Url:</strong>
                                                                                ${c_username}.trainer.jaamun.com</li>

                                                                        </ul>
                                                                        <p
                                                                            style="margin-top: 20px; font-size: 12px; text-align: center; mso-line-height-alt: 25.2px;">
                                                                            Best regards,<br>
                                                                            Jaamun Team
                                                                        </p>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img
                                                                        ...
                                                                        src="https://jmkcrsmn.s3.us-east-2.amazonaws.com/images/round_corner_bottom.png"
                                                                        style="display: block; height: auto; border: 0; width: 680px; max-width: 100%;"
